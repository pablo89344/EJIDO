...
<head>
    ...
    <img src="/Views/Inicio/PaisajePrincipal.jpg" class="imgtop" alt="Imagen de ejido">
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-center">
                <img src="/Views/Inicio/Ruralidades-600x374.jpg" alt="Señor en ejido" class="iamgen-edit img-fluid img-thumbnail responsive-img">
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 d-flex justify-content-center align-items-center">
                <img src="/Views/Inicio/vistacamp.jpg" alt="Muestra de un ejido" class="iamgen-edit img-fluid img-thumbnail responsive-img">
            </div>
    ...
    <style>
        ...
        .imgtop {
            margin-top: 81px; /* Ajusta el valor según sea necesario */
            width: 100%;
            height: auto;
        }
        .section-title {
